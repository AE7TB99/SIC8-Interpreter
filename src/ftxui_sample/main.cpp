...
// configuration step. It creates a namespace called `SIC8`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", SIC8::cmake::project_name, SIC8::cmake::project_version) };
